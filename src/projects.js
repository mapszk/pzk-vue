export const projects = [
  {
    ...
    desc: 'Task Manager App lets you list tasks to do. It also has a timer that you can use with the pomodoro technique to not lose your concentration. Developed with vanilla JavaScript, Html, Scss, and Webpack for bundling.',
    img: '/images/projects/task-manager-app.png',
  ...
  },
  {
    id: 4,
    title: 'Weekout',
    desc: 'Weekout is a website for saving your training routine and divide it into the 7 days of the week. You can create an account and start adding exercises. Weekout is programmed with Next js, Typescript, Chakra UI and Firebase.',
    img: '/images/projects/weekout.png',
    link: 'https://weekout.vercel.app'
  }
]
